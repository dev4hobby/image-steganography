...
parser.add_argument(
    "-in", "--in-image", help="The image to hide the message in.", required=False
)
parser.add_argument(
    "-out", "--out-image", help="The image to save the message in.", required=False
)
parser.add_argument(
    "-m", "--message", help="The message file path to hide.", required=False
)
...
try:
    if message_file_name is None:
        raise ValueError("Message file path is required")
    if in_file_name is None:
        raise ValueError("Input image file path is required")
    if out_file_name is None:
        raise ValueError("Output image file path is required")
